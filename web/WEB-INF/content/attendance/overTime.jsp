            ...
            },
            {
                ...
                template:function(id,rowObject){
                    ...
                    if(rowObject.status == "完成" || rowObject.status == "异常"){
                        str = '<a disable="" class="font-color" href="/overtime/setting/'+id+'.html"  data-pjax="#main-content">编辑</a>'
                        + '<span class="ant-divider"></span>'
                        +'<a  disable="" class="font-color" href="javascript:void(0)" onclick="showDelModal(\'/overtime/delete/'+id+'\')">删除</a>';
                    }else if(rowObject.status == "待计算"){
                        str = '<a <shiro:lacksPermission name="${per}:update">disable=""</shiro:lacksPermission> class="font-color" href="/overtime/setting/'+id+'.html"  data-pjax="#main-content">编辑</a>'
                                + '<span class="ant-divider"></span>'
                                +'<a  <shiro:lacksPermission name="${per}:update">disable=""</shiro:lacksPermission> class="font-color" href="javascript:void(0)" onclick="showDelModal(\'/overtime/delete/'+id+'\')">删除</a>'
            ...
            $("[data-toggle='popover']").popover({placement:"top",html:true})
                    .on('shown.bs.popover', function () {
                        ...
                        $("button[data-id]").click(function(){
                            ...
                            updateType('/overtime/update/'+id,node);
                        });
                    });
