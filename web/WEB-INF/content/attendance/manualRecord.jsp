...
//                }
            ...
            },
            {
                ...
                template:function(id,rowObject){
                    var str = "";
                    str = '<a <shiro:lacksPermission name="${per}:update">disable=""</shiro:lacksPermission> class="font-color" href="/record/manual/setting/'+id+'.html"  data-pjax="#main-content">编辑</a>'
                            + '<span class="ant-divider"></span>'
                            +'<a  <shiro:lacksPermission name="${per}:update">disable=""</shiro:lacksPermission> class="font-color" href="javascript:void(0)" onclick="showDelModal(\'/record/manual/delete/'+id+'\')">删除</a>';
...
<div>
    <div style="margin-bottom: 18px">
        <div>
            ...
            <div>
            <a style="font-size: 14px;color:#2db7f5" href="/record/manual/setting.html" data-pjax="#main-content">签卡登记</a>
            </div>
            <%--<div class="btn-group">--%>
                <%--<button type="button" class="ant-btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">--%>
                    <%--签卡登记 <span class="caret"></span>--%>
                <%--</button>--%>
                <%--<ul class="dropdown-menu" style="font-size: 12px;min-width: 93px">--%>
                    <%--<li><a href="/record/setting.html" data-pjax="#main-content">单个申请--%>
                    <%--</a></li>--%>
                    <%--<li><a href="/record/setting/batch.html" data-pjax="#main-content">批量申请</a></li>--%>
                <%--</ul>--%>
            <%--</div>--%>
        </div>
    </div>
