...
<div>
    <div class="tab-pane fade in active" id="overtime">
        <form class="ant-form ant-form-horizontal" id="overTimeForm" action="/attendancesetting/overtime" onsubmit="">
            <input type="hidden" id="calculateType" name="calculateType" value="${overTime.calculateType}"/>
                    ...
                    <div class="ant-form-item-control ">
                        <div class="ant-radio-group ant-radio-group-large">
                            <label style="font-weight: 500;" class="ant-radio-wrapper ant-radio-wrapper-checked">
                                    <span class="ant-radio <c:if test="${overTime.calculateType == null || overTime.calculateType == 1}">ant-radio-checked</c:if> ">
                            ...
                            <label style="font-weight: 500;" class="ant-radio-wrapper">
                                    <span class="ant-radio <c:if test="${overTime.calculateType == 2}">ant-radio-checked</c:if>">
                                        <span class="ant-radio-inner"></span>
