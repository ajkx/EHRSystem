            ...
            },
            {
                ...
                template:function(id,rowObject){
                    ...
                    if(rowObject.status == "完成"){
                        str = '<a disable="" class="font-color" href="/levelrecord/setting/'+id+'.html"  data-pjax="#main-content">编辑</a>'
                                + '<span class="ant-divider"></span>'
                                +'<a  disable="" class="font-color" href="javascript:void(0)" onclick="showDelModal(\'/levelrecord/delete/'+id+'\')">删除</a>';
                    }else{
                        str = '<a <shiro:lacksPermission name="${per}:update">disable=""</shiro:lacksPermission> class="font-color" href="/levelrecord/setting/'+id+'.html"  data-pjax="#main-content">编辑</a>'
                                + '<span class="ant-divider"></span>'
                                +'<a  <shiro:lacksPermission name="${per}:update">disable=""</shiro:lacksPermission> class="font-color" href="javascript:void(0)" onclick="showDelModal(\'/levelrecord/delete/'+id+'\')">删除</a>';
                    }
                    return  str;
                }
            }
...
<div>
    <div style="margin-bottom: 18px">
        <div>
            ...
            <div>
            <a style="font-size: 14px;color:#2db7f5" href="/levelrecord/setting.html" data-pjax="#main-content">请假申请</a>
            </div>
        </div>
    </div>
